...
class MapControl {
   ...
   static Map createMap() {
    ...
    private static Scene[] createScenes() {
       ...
       basementScene.setDescription("The wineceller underneath the kitchen. The cold dry temperatures"
        ...
        basementScene.setMapSymbol("WC");
        basementScene.setBlocked(false);
        basementScene.setScore(0);
